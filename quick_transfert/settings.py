...
ALLOWED_HOSTS = [h.strip() for h in config('ALLOWED_HOSTS', default='localhost,127.0.0.1,.onrender.com').split(',')]
...
WHITENOISE_USE_FINDERS = True # Fallback to STATICFILES_DIRS if not in STATIC_ROOT
